...
using PhoneBookDemo.DemoUiComponents.Dto;

namespace PhoneBookDemo.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : PhoneBookDemoAppServiceBase, IDemoUiComponentsAppService
    {

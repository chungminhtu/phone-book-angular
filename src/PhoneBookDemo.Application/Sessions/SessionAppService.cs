...
{
    public class SessionAppService : PhoneBookDemoAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = PhoneBookDemoConsts.Currency,
                    CurrencySign = PhoneBookDemoConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = PhoneBookDemoConsts.AllowTenantsToChangeEmailSettings
                }
            };

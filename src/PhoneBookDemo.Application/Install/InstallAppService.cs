...
namespace PhoneBookDemo.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : PhoneBookDemoAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<PhoneBookDemoDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(PhoneBookDemoConsts.ConnectionStringName).Value.ToString();
        }

...
using PhoneBookDemo.Auditing.Exporting;
...
using EntityHistoryHelper = PhoneBookDemo.EntityHistory.EntityHistoryHelper;

namespace PhoneBookDemo.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : PhoneBookDemoAppServiceBase, IAuditLogAppService
    {

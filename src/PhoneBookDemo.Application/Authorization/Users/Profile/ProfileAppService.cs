...
using PhoneBookDemo.Authentication.TwoFactor.Google;
using PhoneBookDemo.Authorization.Users.Dto;
using PhoneBookDemo.Authorization.Users.Profile.Cache;
using PhoneBookDemo.Authorization.Users.Profile.Dto;
using PhoneBookDemo.Friendships;
using PhoneBookDemo.Gdpr;
using PhoneBookDemo.Identity;
using PhoneBookDemo.Net.Sms;
using PhoneBookDemo.Security;
using PhoneBookDemo.Storage;
using PhoneBookDemo.Timing;

namespace PhoneBookDemo.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : PhoneBookDemoAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("PhoneBookDemo",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("PhoneBookDemo",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }

...
using PhoneBookDemo.Authorization.Permissions;
...
using PhoneBookDemo.Authorization.Users.Exporting;
...
namespace PhoneBookDemo.Authorization.Users
{
    ...
    public class UserAppService : PhoneBookDemoAppServiceBase, IUserAppService
    {

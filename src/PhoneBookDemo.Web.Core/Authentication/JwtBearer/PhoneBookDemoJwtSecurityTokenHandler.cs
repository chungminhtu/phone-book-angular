...
namespace PhoneBookDemo.Web.Authentication.JwtBearer
{
    public class PhoneBookDemoJwtSecurityTokenHandler : ISecurityTokenValidator
    {
        private readonly JwtSecurityTokenHandler _tokenHandler;

        public PhoneBookDemoJwtSecurityTokenHandler()
        {

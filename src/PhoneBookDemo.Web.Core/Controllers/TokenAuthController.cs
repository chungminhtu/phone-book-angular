...
using PhoneBookDemo.Authorization.Accounts.Dto;
...
using PhoneBookDemo.Web.Models.TokenAuth;
using PhoneBookDemo.Authorization.Impersonation;
...
using PhoneBookDemo.Web.Authentication.External;
using PhoneBookDemo.Web.Common;

namespace PhoneBookDemo.Web.Controllers
{
    [Route("api/[controller]/[action]")]
    public class TokenAuthController : PhoneBookDemoControllerBase
    {

...
using PhoneBookDemo.MultiTenancy.Demo;
...
namespace PhoneBookDemo.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(PhoneBookDemoConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");

...
namespace PhoneBookDemo.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : PhoneBookDemoServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("PhoneBookDemo", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);

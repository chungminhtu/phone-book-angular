...
using PhoneBookDemo.Authorization.Accounts;
...
using PhoneBookDemo.Web.Models.Ui;
using PhoneBookDemo.Web.Session;

namespace PhoneBookDemo.Web.Controllers
{
    public class UiController : PhoneBookDemoControllerBase
    {

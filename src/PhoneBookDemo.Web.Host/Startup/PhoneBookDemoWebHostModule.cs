...
namespace PhoneBookDemo.Web.Startup
{
    ...
    public class PhoneBookDemoWebHostModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PhoneBookDemoWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PhoneBookDemoWebHostModule).GetAssembly());
        }

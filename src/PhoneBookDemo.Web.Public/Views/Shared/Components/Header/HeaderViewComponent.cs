...
using PhoneBookDemo.Web.Public.Startup;
using PhoneBookDemo.Web.Session;

namespace PhoneBookDemo.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PhoneBookDemoViewComponent
    {

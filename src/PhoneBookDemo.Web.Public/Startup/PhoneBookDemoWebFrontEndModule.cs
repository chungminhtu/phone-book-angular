...
{
    [DependsOn(
        typeof(PhoneBookDemoWebCoreModule)
    )]
    public class PhoneBookDemoWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PhoneBookDemoWebFrontEndModule(IHostingEnvironment env, PhoneBookDemoEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PhoneBookDemoWebFrontEndModule).GetAssembly());
        }
    }
}

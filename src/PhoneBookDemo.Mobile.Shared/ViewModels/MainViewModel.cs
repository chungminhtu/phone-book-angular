...
using MvvmHelpers;
using PhoneBookDemo.Authorization.Users.Profile;
using PhoneBookDemo.Authorization.Users.Profile.Dto;
using PhoneBookDemo.Commands;
...
using PhoneBookDemo.Controls;
using PhoneBookDemo.Dto;
using PhoneBookDemo.Extensions;
using PhoneBookDemo.Localization;
using PhoneBookDemo.UI;
using PhoneBookDemo.UI.Assets;
using PhoneBookDemo.Views;
using DependencyResolver = PhoneBookDemo.Core.Dependency.DependencyResolver;
...
namespace PhoneBookDemo.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "PhoneBookDemo";

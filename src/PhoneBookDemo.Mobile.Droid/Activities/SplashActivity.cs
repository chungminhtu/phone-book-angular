...
using PhoneBookDemo.Localization.Resources;
using PhoneBookDemo.ViewModels.Base;
using Plugin.Connectivity;
using Process = Android.OS.Process;

namespace PhoneBookDemo.Activities
{
    ...
    public class SplashActivity : AppCompatActivity
    {
        ...
        {
            base.OnResume();
            ApplicationBootstrapper.InitializeIfNeeds<PhoneBookDemoXamarinAndroidModule>();

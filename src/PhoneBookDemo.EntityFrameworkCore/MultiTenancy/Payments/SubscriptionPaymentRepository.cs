...
using PhoneBookDemo.EntityFrameworkCore.Repositories;

namespace PhoneBookDemo.MultiTenancy.Payments
{
    public class SubscriptionPaymentRepository : PhoneBookDemoRepositoryBase<SubscriptionPayment, long>, ISubscriptionPaymentRepository
    {
        public SubscriptionPaymentRepository(IDbContextProvider<PhoneBookDemoDbContext> dbContextProvider)

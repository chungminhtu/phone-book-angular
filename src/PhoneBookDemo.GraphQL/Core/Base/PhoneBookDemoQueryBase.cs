...
namespace PhoneBookDemo.Core.Base
{
    public abstract class PhoneBookDemoQueryBase<TField,TResult> : ITransientDependency
    {
        ...
        protected PhoneBookDemoQueryBase(string fieldName,

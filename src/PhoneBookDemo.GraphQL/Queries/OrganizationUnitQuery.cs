...
using PhoneBookDemo.Core.Base;
using PhoneBookDemo.Core.Extensions;
using PhoneBookDemo.Dto;
using PhoneBookDemo.Types;

namespace PhoneBookDemo.Queries
{
    public class OrganizationUnitQuery : PhoneBookDemoQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
